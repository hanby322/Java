...
public class ArrayLinkedListTester {
    ...
    static Menu SelectMenu() {
        ...
        do {
            for (Menu m: Menu.values()) {
                ...
                if ((m.ordinal() % 3) == 2 && m.ordinal() != Menu.TERMIANTE.ordinal())
                    System.out.println();
            }
            System.out.print(" : ");
            key = stdIn.nextInt();
        } while (key < Menu.ADD_FIRST.ordinal() || key > Menu.TERMIANTE.ordinal());
    ...
    public static void main(String[] args) {
        ...
        ArrayLinkedList<Data> list = new ArrayLinkedList<Data>(100); // 리스트를 생성
