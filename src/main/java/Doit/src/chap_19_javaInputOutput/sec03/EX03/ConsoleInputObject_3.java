package chap_19_javaInputOutput.sec03.EX03;
...
public class ConsoleInputObject_3 {
    public static void main(String[] args) throws IOException {
        ...
        String str2 = new String(byteArray2, 0, offset + count2, "UTF-8");
        // String str2 = new String(byteArray2, offset, count2, "UTF-8");
