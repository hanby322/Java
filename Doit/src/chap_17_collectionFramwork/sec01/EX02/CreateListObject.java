package chap_17_collectionFramwork.sec01.EX02;
...
//        List<Integer> aList6 = new LinkedList<>(30) // 저장 용량 지정 불가
        ...
        aList7.set(1, 7);
        aList8.set(0, "감사"); // 0 번째 인덱스에 "감사" 문자열로 변경
//      aList7.add(5);    // 불가능(내부 구조는 배열과 동일하기 때문에 크기 변경 불가)
//      aList8.remove(0); // 불가능(내부 구조는 배열과 동일하기 때문에 크기 변경 불가)
